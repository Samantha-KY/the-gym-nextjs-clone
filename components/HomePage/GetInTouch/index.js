    ...
    <section className="bg-primary-bg px-36">
      <div className="flex justify-between max-w-7xl mx-auto py-40">
        <div>
          ...
          <h1 className="text-content-green-primary font-bold text-3xl">
            Get In Touch
          </h1>
          ...
          <div className="flex flex-col gap-5 mt-20">
            <div className="flex gap-5">
              <img
                src="/contact1.svg"
                alt="contact icon"
                className="bg-repetitive-bg p-4 rounded-md w-fit h-fit"
              />
              <div className="flex flex-col">
                <p className="text-content-green-secondary text-lg font-semibold mt-2">
                  Tel
                </p>
                <p className="text-content-green-primary font-bold text-xsm">
                  708-790-0000
                </p>
              </div>
            </div>
        ...
        <div className="bg-repetitive-bg rounded-xsm shadow-2xl shadow-content-green-secondary w-fit h-fit -mt-5">
          <div className="flex flex-col gap-5 p-6">
            ...
            <Button
              title="Send message"
              className="bg-primary-green rounded-xsm text-white py-2 h-11 w-[25rem] font-bold shadow-2xl shadow-content-green-secondary"
            />
          </div>
        </div>
      </div>
